...
## 尝鲜
[Hub Mirror Action的Python版本](https://github.com/Yikun/hub-mirror-action/issues/88)已经可用，更稳定、更流畅，欢迎尝鲜使用。

您只需要将`uses`改为`uses: Yikun/hub-mirror-action@python`即可启用。
